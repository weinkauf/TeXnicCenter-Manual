# -*- coding: utf-8 -*-
#
# TeXnicCenter documentation build configuration file, created by
...
project = u'TeXnicCenter'
copyright = u'2010, The TeXnicCenter Team'
...
latex_documents = [
  ('index', 'TeXnicCenter.tex', u'TeXnicCenter Documentation',
   u'The TeXnicCenter Team', 'manual'),
]
